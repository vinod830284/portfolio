          ...
          {highlightsData.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group p-6 rounded-2xl bg-white dark:bg-[#11151A] border border-slate-200 dark:border-white/10 hover:border-accent-blue/40 hover:shadow-glow-blue transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  ...
                  <h3 className="text-xl font-bold text-slate-900 dark:text-[#F5F7FA] group-hover:text-accent-blue transition-colors">
                    {item.title}
                  </h3>
                  <p className="mt-2.5 text-sm text-slate-600 dark:text-[#A5ACB8] leading-relaxed">
                    {item.description}
                  </p>
                </div>
              </motion.div>
