...
import { Code2, Zap, Layers, Radio, Cpu, ShieldCheck, GraduationCap } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-white/10 flex items-center gap-3">
              <div className="w-9 h-9 rounded-lg bg-accent-violet/10 flex items-center justify-center text-accent-violet shrink-0">
                <GraduationCap className="w-5 h-5" />
              </div>
              <div className="text-left">
                <div className="text-xs font-mono text-slate-500 dark:text-[#6F7785]">Education</div>
                <div className="text-sm font-semibold text-slate-900 dark:text-[#F5F7FA]">
                  Bachelor of Computer Applications (BCA) <span className="text-xs font-normal text-slate-500 dark:text-[#6F7785]">(2020 – 2023)</span>
                </div>
                <div className="text-xs text-slate-500 dark:text-[#6F7785]">
